...
#
GL="/vendor/lib/egl/libEGL_mtk.so /vendor/lib/egl/libGLESv1_CM_mtk.so /vendor/lib/egl/libGLESv2_mtk.so \
/vendor/lib/hw/gralloc.mt6580.so \
...
/lib/libm4u.so /lib/hw/hwcomposer.mt6580.so /lib/libbwc.so /lib/libgpu_aux.so \
...
AUDIO="/lib/hw/audio.primary.mt6580.so /lib/libspeech_enh_lib.so /lib/libaudiocustparam.so /lib/libaudiosetting.so \
...
CAMERA="/lib/hw/camera.mt6580.so \
/lib/libcamera_client_mtk.so /lib/libcam.halsensor.so /lib/libcam_hwutils.so /lib/libcam_utils.so /lib/libmmsdkservice.so /lib/libmmsdkservice.feature.so \
...
/lib/libcam.device1.so /lib/libcamdrv.so /lib/libcameracustom.so /lib/libcam.exif.so /lib/libcam.iopipe.so \
...
MISC="/bin/akmd8963 /bin/akmd8975 /bin/akmd09911 /bin/ami304d /bin/bmm050d /bin/mc6420d /bin/memsicd /bin/memsicd3416x \
/bin/s62xd /bin/thermal /bin/thermald /bin/thermal_manager /lib/libmtcloader.so \
/bin/ppl_agent /bin/matv \
/bin/ipod /lib/libpparam.so \
"
...
move_files () {
	...
	#rename_file $1 lib/hw/audio.primary.mt6580.so lib/libaudio.primary.default.so
	#rename_file $1 vendor/lib/hw/audio.a2dp.blueangel.so vendor/lib/hw/audio.a2dp.mt6580.so
	true
}
